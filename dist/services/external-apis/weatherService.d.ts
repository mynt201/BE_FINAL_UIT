...
declare class WeatherAPIService {
    private apiKey;
    private baseUrl;
    private cache;
    ...
    getWeatherForecast(location: string, days?: number): Promise<WeatherData | null>;
    getHistoricalWeather(location: string, date: string): Promise<WeatherData | null>;
