...
wardSchema.pre('save', function (next) {
  if (
    this.isModified('population_density') ||
...
export default mongoose.model<IWardDocument, IWardModel>('Ward', wardSchema);
